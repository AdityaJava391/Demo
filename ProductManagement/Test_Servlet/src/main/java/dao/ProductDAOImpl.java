...
public class ProductDAOImpl implements ProductDAO {
	...
	private static final String INSERT_PRODUCT_SQL="INSERT INTO PRODUCT (product_name,price,quantity_in_stock,vendor,waranty) VALUES (?,?,?,?,?)";
    
	private static final String SELECT_PRODUCT_BY_ID="SELECT id,product_name,price,quantity_in_stock,vendor,waranty WHERE id=? ";
	
	private static final String SELECT_ALL_PRODUCT="SELECT * FROM PRODUCT";
	
	private static final String DELETE_PRODUCT_BY_ID="DLEETE FROM PRODUCT WHERE ID=?";
	
	private static final String UPDATE_PROD="UPDATE PRODUCT set product_name=? ,price=?,quantity_in_stock=?,vendor=?,waranty=? where id=?";
