...
public class ProductController extends HttpServlet{
	...
	private void showNewForm(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		RequestDispatcher dispatcher=request.getRequestDispatcher("webapp/productForm.jsp");
	}
	...
	private void listProduct(HttpServletRequest request,HttpServletResponse response) {
	  ...
	  private void editProduct(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
			        ...
			        RequestDispatcher dispatcher = request.getRequestDispatcher("webapp/product-form.jsp");
